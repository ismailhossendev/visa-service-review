...
const AddService = () => {
    ...
    return (
        <main className="flex min-h-screen flex-col justify-center p-10">
            ...
            <form className="mx-auto rounded-xl border border-black  py-6 p-4 lg:w-1/2  shadow-2xl shadow-white/40">
                ...
                <div className="grid md:grid-cols-2 gap-2">
                    <div className="mb-4 flex flex-col">
                        <label htmlFor="image" className="mb-2 font-semibold">Cover image</label>
                            <input type="file" id="image" name='image' className="w-full rounded-lg border border-slate-400 pb-0.5 hover:border-blue-500 focus:outline-none focus:ring focus:ring-blue-500/40 active:ring active:ring-blue-500/40" />
                    </div>
                    <div className="mb-4 flex flex-col">
